...
> **Rule:** `.claude/skills/openspec-gap-analysis/SKILL.md`  
> **Command alias:** `/gaps-spec` (`.claude/commands/gaps-spec.md`)  
...
- `.claude/skills/openspec-gap-analysis/SKILL.md`
- `.claude/skills/multiagente/SKILL.md`
- `.claude/skills/30-openspec-anti-hallucination/SKILL.md`
- `.claude/skills/mejora-tarea/SKILL.md` — hydrate after gaps
- `.claude/skills/aplica-tarea/SKILL.md` — implement after READY
