...
Read `.claude/skills/00-openspec-stack-agnostic/SKILL.md` and the target project's stack rule for **source path layout** (e.g. `src/`, `apps/api/`, `packages/`, `web/modules/custom/`).
