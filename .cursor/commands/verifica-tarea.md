...
1. Read **`.cursor/skills/verifica-tarea/SKILL.md`** in the same turn before executing.
2. Load **`.cursor/rules/verifica-tarea-openspec-a-fondo.mdc`** (L2).
...
Full detail: `.cursor/skills/verifica-tarea/SKILL.md`.
...
- `.cursor/rules/verifica-tarea-openspec-a-fondo.mdc` (L2)
- `.cursor/rules/comando-verificar-a-fondo.mdc` (L2 — diff-scoped cousin)
