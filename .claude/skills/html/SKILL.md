...
> **Command:** `.claude/commands/html.md`  
> **Rule (L2):** `.claude/skills/html/SKILL.md`
...
ABS="${REPO_ROOT}/.claude/context/…/doc.html"
...
**Forbidden for human viewing:** `browser_navigate`, in-IDE preview browser (VS Code/JetBrains extension), Glass, `open_resource` for web preview (`open-links-in-chrome-not-ide.mdc`).
...
|----------------|-------------|
| “el informe QA” | Latest `qa-report-*.html` in `.claude/QAtest/` or `documentacion/` |
| “la matriz” | `.claude/context/verification/<slug>/matrix.html` |
