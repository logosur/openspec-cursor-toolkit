...
> **Command:** `.claude/commands/cierra-sesion.md`
...
Si después de clasificar queda algo **que solo el desarrollador sabe**, se abre un diálogo de preguntas (`AskUserQuestion`) **antes** del veredicto.
