...
1. Read **`.cursor/skills/qa/SKILL.md`** in the same turn before executing.
2. Load **`.cursor/rules/comando-qa.mdc`** (L2).
...
Full detail: `.cursor/skills/qa/SKILL.md`.
...
```text
.cursor/QAtest/<run-slug>/matrix.md
```
...
- `.cursor/rules/comando-qa.mdc` (L2)
