...
1. Leer y seguir **`.cursor/skills/supervisa-sesiones/SKILL.md`**.
...
3. Abrir el registro `.cursor/context/supervisor/SUPERVISOR-<YYYYMMDD-HHMM>.md` y escribirlo **después de cada transición de fase**.
...
| Subagente de F6 | 20 min | Se corta, se verifica en disco lo que dejó, su decisión vuelve a la cola |
...
**Se pregunta** (AskQuestion en Cursor, o pregunta explícita en el chat; en tandas de hasta 4, con opciones explicadas en lenguaje natural): hallazgos que no pertenecen a ninguna sesión, alcance ambiguo, prioridad entre sesiones que se estorban, rojos preexistentes, riesgos de publicación, y qué hacer con una sesión que no responde.
...
| Item | Ruta |
|------|------|
| Skill | `.cursor/skills/supervisa-sesiones/SKILL.md` |
| Regla | `.cursor/rules/supervisa-sesiones-multisesion.mdc` |
| Cierre de una sesión | `.cursor/commands/cierra-sesion.md` |
| Loop de una spec | `.cursor/commands/run-spec.md` |
| Pipeline de revisión | `.cursor/commands/repasa-spec.md` |
