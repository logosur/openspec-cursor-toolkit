...
1. Read **`.claude/skills/comando-verificar/SKILL.md`** in the same turn before executing.
2. Load **`.claude/skills/comando-verificar/SKILL.md`** (L2).
...
Full detail: `.claude/skills/comando-verificar/SKILL.md`.
...
- `.claude/skills/comando-verificar/SKILL.md` (L2)
