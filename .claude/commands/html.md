...
1. Read **`.claude/skills/html/SKILL.md`** in the same turn before executing.
2. Load **`.claude/skills/html/SKILL.md`** (L2).
...
|-------------|---------|--------|
| Absolute/relative path | `/html .claude/context/informes/bug-500.html` | Resolve to repo-absolute `.html` |
...
|------|-----------------|
| `.claude/context/` | Informes, matrices, evidencia, planes |
| `.claude/QAtest/` | QA HTML reports |
...
| Item | Role |
|------|------|
| `.claude/skills/html/SKILL.md` | Full resolution + HTML generation workflow |
| `.claude/skills/html/SKILL.md` | L2 triggers and prohibitions |
